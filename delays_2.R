...
plot(outX[,1],outX[,2],type='l',col='red',lwd=3,ylim=c(0,5),xlab='t',ylab='',cex.lab=1.5,cex.axis=1.5)
...
plot(outX[,1],outX[,3],type='l',col='red',lwd=3,ylim=c(0,5),xlab='t',ylab='',cex.lab=1.5,cex.axis=1.5)
