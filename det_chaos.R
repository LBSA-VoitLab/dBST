...
par(mfrow=c(2,1))
plot(d_output3[,1],d_output3[,2],pch=20,col = "blue",xlab='t',ylab='',ylim=c(-70,70),cex.lab=1.5,cex.axis=1.5)
...
plot(d_output3[,3],d_output3[,4],type='l',col='darkcyan',lwd=2,xlim=c(-40,40),ylim=c(0,70),xlab = expression('X'[2]),ylab = expression('X'[3]),cex.lab=1.2,cex.axis=1.5)
